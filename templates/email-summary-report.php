...
<body style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #F5F2E9;">
	...
	<div role="article" aria-roledescription="email" lang="<?php echo esc_attr( get_locale() ); ?>" style="text-size-adjust: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; background-color: #F5F2E9;">
		...
		<!-- Footer -->
		<tr>
			<td style="background-color: #ffffff; border-radius: 0 0 8px 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" class="email-container">
				<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
					<tr>
						<td style="padding: 30px 40px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; text-align: center; background-color: #ffffff;" class="mobile-padding email-container">
							
							<!-- Footer Text -->
							<p style="margin: 0 0 20px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666666; text-align: center;">
								<?php echo esc_html( __( 'This email was automatically generated by Simple History.', 'simple-history' ) ); ?>
							</p>
							
							<!-- Unsubscribe Link -->
							<p style="margin: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; font-size: 12px; line-height: 16px; color: #999999; text-align: center;">
								<a href="<?php echo esc_url( $learn_how_to_unsubscribe_url ); ?>" style="color: #999999; text-decoration: underline;">
									<?php echo esc_html( __( 'Learn how to unsubscribe from these emails', 'simple-history' ) ); ?>
								</a>
							</p>
