...
-   Calendar view on the event log — toggle between List and Calendar to browse events in a month/week/day grid, with per-day severity indicators and mini event previews.
