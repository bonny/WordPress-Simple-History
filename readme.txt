...
- You can show a different number of log items in the log on the dashboard and on the history's own page. By default the dashboard will show 5 items and the page will show 30.
