...
-   Using WordPress components makes the usability and accessibility of the GUI better. Keyboard navigation and screen reader support is improved.
...
-   Minimum required WordPress version is now 6.6.
