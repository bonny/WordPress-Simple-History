...
-   A user's Simple History activity-log events are now included in WordPress's personal-data export (Tools → Export Personal Data). Previously the activity log was silently left out of export requests.
