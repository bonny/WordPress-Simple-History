...
class Admin_Pages extends Service {
	/**
	 * Logo SVG used as the WordPress menu icon for Simple History.
	 * Same source as in AdminBarQuickView.scss
	 ...
	 *
	 * Only rendered when SIMPLE_HISTORY_DEV is enabled.
	 * Shared between the regular admin page header and the network admin page.
	 *
	 * @since 5.6.0
	 */
