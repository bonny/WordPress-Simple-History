...
class Notes_Logger extends Logger {
	...
	public function get_info() {
		$arr_info = [
			...
			'messages'    => [
				'note_added_to_block'       => _x( 'Added note to {block_type} block: "{block_content_preview}"', 'Logger: Notes', 'simple-history' ),
				'note_added'                => _x( 'Added note', 'Logger: Notes', 'simple-history' ),
				'note_reply_added_to_block' => _x( 'Replied to note on {block_type} block: "{block_content_preview}"', 'Logger: Notes', 'simple-history' ),
				'note_reply_added'          => _x( 'Replied to note', 'Logger: Notes', 'simple-history' ),
				'note_edited'               => _x( 'Edited note on "{post_title}"', 'Logger: Notes', 'simple-history' ),
				'note_deleted_from_block'   => _x( 'Deleted note from {block_type} block: "{block_content_preview}"', 'Logger: Notes', 'simple-history' ),
				'note_deleted'              => _x( 'Deleted note', 'Logger: Notes', 'simple-history' ),
				'note_resolved'             => _x( 'Resolved note on "{post_title}"', 'Logger: Notes', 'simple-history' ),
				'note_reopened'             => _x( 'Reopened note on "{post_title}"', 'Logger: Notes', 'simple-history' ),
			],
			'labels'      => [
				'search' => [
