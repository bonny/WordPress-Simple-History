...
class Notes_Logger extends Logger {
	...
	public function get_info() {
		$arr_info = [
			...
			'messages'    => [
				'note_added_to_block'       => _x( 'Added note to {block_type} block in post "{post_title}"', 'Logger: Notes', 'simple-history' ),
				'note_added'                => _x( 'Added note to post "{post_title}"', 'Logger: Notes', 'simple-history' ),
				'note_reply_added_to_block' => _x( 'Replied to note on {block_type} block in post "{post_title}"', 'Logger: Notes', 'simple-history' ),
				'note_reply_added'          => _x( 'Replied to note in post "{post_title}"', 'Logger: Notes', 'simple-history' ),
				'note_edited'               => _x( 'Edited note in post "{post_title}"', 'Logger: Notes', 'simple-history' ),
				'note_deleted_from_block'   => _x( 'Deleted note from {block_type} block in post "{post_title}"', 'Logger: Notes', 'simple-history' ),
				'note_deleted'              => _x( 'Deleted note from post "{post_title}"', 'Logger: Notes', 'simple-history' ),
				'note_resolved'             => _x( 'Resolved note in post "{post_title}"', 'Logger: Notes', 'simple-history' ),
				'note_reopened'             => _x( 'Reopened note in post "{post_title}"', 'Logger: Notes', 'simple-history' ),
			],
			'labels'      => [
				'search' => [
