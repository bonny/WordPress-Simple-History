...
It does however require you to write some code for this to work.
...
So it depends on how you use the plugin. The [GDPR law](https://en.wikipedia.org/wiki/General_Data_Protection_Regulation) is complicated and I am not a lawyer so I can't say if its compliant for you site. It's my understanding that it depends on so many things.
